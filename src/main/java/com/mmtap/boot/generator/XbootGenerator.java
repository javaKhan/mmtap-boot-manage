...
import com.mmtap.boot.generator.bean.EntityOfEntity;
...
public class XbootGenerator {
     ...
     * 实体类对应包
     */
    private static final String entityPackage = "com.mmtap.boot.entity";

    /**
     * dao对应包
     */
    private static final String daoPackage = "com.mmtap.boot.dao";

    /**
     * service对应包
     */
    private static final String servicePackage = "com.mmtap.boot.service";

    /**
     * serviceImpl对应包
     */
    private static final String serviceImplPackage = "com.mmtap.boot.serviceimpl";

    /**
     * controller对应包
     */
    private static final String controllerPackage = "com.mmtap.boot.controller";
    ...
    private static void generateCode(GroupTemplate gt) throws IOException{
        ...
        //创建文件
        String entityFileUrl = System.getProperty("user.dir")+"/src/main/java/com/mmtap/boot/entity/"+className+".java";
        ...
        log.info(daoResult);
        //创建文件
        String daoFileUrl = System.getProperty("user.dir")+"/src/main/java/com/mmtap/boot/dao/"+className+"Dao.java";
        ...
        //创建文件
        String serviceFileUrl = System.getProperty("user.dir")+"/src/main/java/com/mmtap/boot/service/"+className+"Service.java";
        ...
        //创建文件
        String serviceImplFileUrl = System.getProperty("user.dir")+"/src/main/java/com/mmtap/boot/serviceimpl/"+className+"ServiceImpl.java";
        ...
        //创建文件
        String controllerFileUrl = System.getProperty("user.dir")+"/src/main/java/com/mmtap/boot/controller/"+className+"Controller.java";
